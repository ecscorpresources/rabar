...
import facebook from '../assets/img/66.png';
import youtube from '../assets/img/67.png';
import instagram from '../assets/img/68.png';
import twitter from '../assets/img/69.png';
import linkedin from '../assets/img/74.png';
import phone from '../assets/img/75.png';
...
export const Social = styled.input`
  border: 1px solid ${colors.colorBlue};
  border-radius: 4px;
  width: 100%;
  resize: none;
